...
plt.ylabel('Amplitude')
print('Channel 0 Original FFT Amplitude')
...
plt.xlabel('Frequency (Hz)')
plt.ylabel('Amplitude')
print('Channel 0 Filtered FFT Amplitude')
plt.xlim(0, min(sample/2, CUTOFF_HZ * 5))
plt.grid(alpha=0.3)
plt.tight_layout()
plt.show()
...
plt.xlabel('Time (s)')
plt.ylabel('Amplitude')
print(f'Channel 0 Original Time (first {SHORT_SEC} s)')
...
plt.xlabel('Time (s)')
plt.ylabel('Amplitude')
print(f'Channel 0 Filtered Time (first {SHORT_SEC} s)')
plt.xlim(time_index[short_slice.start], time_index[short_slice.stop - 1])
plt.grid(alpha=0.3)
plt.tight_layout()
plt.show()
...
plt.xlabel('Frequency (Hz)')
plt.ylabel('Amplitude')
print('Channel 1 Original FFT Amplitude')
plt.xlim(0, min(sample/2, CUTOFF_HZ * 5))
plt.grid(alpha=0.3)
plt.tight_layout()
plt.show()
...
plt.xlabel('Frequency (Hz)')
plt.ylabel('Amplitude')
print('Channel 1 Filtered FFT Amplitude')
plt.xlim(0, min(sample/2, CUTOFF_HZ * 5))
plt.grid(alpha=0.3)
plt.tight_layout()
plt.show()
...
plt.xlabel('Time (s)')
plt.ylabel('Amplitude')
print(f'Channel 1 Original Time (first {SHORT_SEC} s)')
plt.xlim(time_index[short_slice.start], time_index[short_slice.stop - 1])
plt.grid(alpha=0.3)
plt.tight_layout()
plt.show()
...
plt.xlabel('Time (s)')
plt.ylabel('Amplitude')
print(f'Channel 1 Filtered Time (first {SHORT_SEC} s)')
plt.xlim(time_index[short_slice.start], time_index[short_slice.stop - 1])
plt.grid(alpha=0.3)
plt.tight_layout()
plt.show()
