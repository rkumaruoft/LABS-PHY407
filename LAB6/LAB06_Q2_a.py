...
def run_for_N(N):
    ...
    # use the lowest nonzero mode frequency to define "few cycles"
    omega_min = omegas[0] if omegas[0] > 1e-12 else omegas[1] if N > 1 else omegas[0]
    ...
    plt.stem(np.arange(1, N + 1), amps, basefmt=" ", use_line_collection=True)
